...
class DefaultTextProcessorTest {
    private val fakeDictionaryDao = object : PersonalizedEntryDao {
        ...
        override suspend fun findByNormalizedPhrase(normalized: String): PersonalizedEntryEntity? = null
    ...
    fun `converts one hundred and thirty seven`() {
        assertEquals(
            expectedPost("The answer is 137."),
            processor.process("the answer is one hundred and thirty seven"),
        )
    }
    ...
    fun `converts three thousand five hundred`() {
        assertEquals(
            expectedPost("The altitude is 3500 feet."),
            processor.process("the altitude is three thousand five hundred feet"),
        )
    }
