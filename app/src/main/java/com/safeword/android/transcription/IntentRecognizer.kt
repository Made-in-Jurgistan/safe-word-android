...
object IntentRecognizer {
    ...
    data class Intent(
        ...
        /**
         * Keyword weights pre-sorted in descending order. Used by [scoreIntent] to
         * compute the top-K weight denominator without re-sorting on every score call.
         */
        internal val descendingWeights: FloatArray =
            keywords.map { it.second }.sortedDescending().toFloatArray()
    }
    ...
    private val intents: List<Intent> = buildList {
        ...
        add(Intent(
            ...
            keywords = listOf(
                "delete" to 1.5f, "remove" to 1.2f, "erase" to 1.2f,
                "that" to 0.5f, "this" to 0.5f, "selection" to 0.8f,
            ),
            destructive = true,
        ))
        add(Intent(
            ...
            keywords = listOf(
                "delete" to 1.5f, "erase" to 1.2f, "remove" to 1.0f,
                "last" to 1.0f, "word" to 1.5f, "previous" to 0.8f,
            ),
            destructive = true,
        ))
        add(Intent(
            ...
            keywords = listOf(
                "delete" to 1.5f, "erase" to 1.2f, "remove" to 1.0f,
                "last" to 1.0f, "sentence" to 1.5f, "previous" to 0.8f,
            ),
            destructive = true,
        ))
        add(Intent(
            ...
            keywords = listOf(
                "clear" to 1.5f, "erase" to 1.2f, "delete" to 1.0f,
                "remove" to 1.2f, "all" to 1.2f, "everything" to 1.2f,
                "entire" to 0.8f, "whole" to 0.8f,
            ),
            destructive = true,
        ))
        ...
        add(Intent(
            ...
            keywords = listOf(
                "undo" to 2.0f, "scratch" to 1.2f, "take" to 0.5f,
                "back" to 0.8f, "revert" to 1.5f, "reverse" to 1.0f,
            ),
            destructive = true,
        ))
        add(Intent(
        ...
        add(Intent(
            ...
            keywords = listOf(
                "select" to 1.5f, "highlight" to 1.2f, "all" to 1.5f,
                "everything" to 1.2f, "entire" to 0.8f,
            ),
        ))
        ...
        add(Intent(
            ...
            keywords = listOf(
                "move" to 0.8f, "go" to 0.8f, "jump" to 0.8f,
                "cursor" to 0.5f, "end" to 1.5f, "bottom" to 1.0f,
            ),
        ))
        add(Intent(
            ...
            keywords = listOf(
                "move" to 0.8f, "go" to 0.8f, "jump" to 0.8f,
                "cursor" to 0.5f, "start" to 1.2f, "beginning" to 1.5f,
                "top" to 1.0f,
            ),
        ))
        ...
        add(Intent(
            ...
            keywords = listOf(
                "capitalize" to 2.0f, "capital" to 1.5f, "that" to 0.3f,
                "this" to 0.3f, "selection" to 0.5f,
            ),
        ))
        add(Intent(
        ...
        add(Intent(
            ...
            keywords = listOf(
                "select" to 1.5f, "highlight" to 1.2f, "last" to 1.2f,
                "previous" to 1.0f, "word" to 1.5f,
            ),
        ))
        add(Intent(
            ...
            keywords = listOf(
                "select" to 1.5f, "highlight" to 1.2f, "last" to 1.2f,
                "previous" to 1.0f, "sentence" to 1.5f,
            ),
        ))
        add(Intent(
        ...
        add(Intent(
            ...
            keywords = listOf(
                "select" to 1.5f, "highlight" to 1.2f, "this" to 1.0f,
                "current" to 1.0f, "sentence" to 1.5f,
            ),
        ))
        ...
        add(Intent(
            ...
            keywords = listOf(
                "delete" to 1.5f, "erase" to 1.2f, "remove" to 1.0f,
                "last" to 1.0f, "paragraph" to 1.5f, "previous" to 0.8f,
            ),
            destructive = true,
        ))
        ...
        add(Intent(
            ...
            keywords = listOf(
                "stop" to 1.5f, "listening" to 1.5f, "recording" to 1.2f,
                "dictation" to 1.2f, "done" to 1.5f, "finished" to 1.0f,
                "that's" to 0.5f, "enough" to 0.5f,
            ),
        ))
        add(Intent(
        ...
        add(Intent(
            ...
            keywords = listOf(
                "open" to 0.8f, "settings" to 2.0f, "preferences" to 1.5f,
                "configuration" to 1.0f, "safe" to 0.3f, "word" to 0.3f,
            ),
        ))
        add(Intent(
        ...
        add(Intent(
            action = VoiceAction.Backspace,
            keywords = listOf(
                "backspace" to 2.0f, "delete" to 1.2f, "remove" to 1.0f,
                "last" to 1.0f, "character" to 1.5f,
            ),
            destructive = true,
        ))
    }
    ...
    private fun scoreIntent(intent: Intent, tokens: List<String>, fullText: String): Float {
        ...
        // instead of totalWeight. This avoids penalizing intents that define many
        // synonym triggers — only the strongest K weights matter. Weights are
        // pre-sorted in [Intent.descendingWeights] so this is an O(K) sum.
        val descending = intent.descendingWeights
        val k = matchedCount.coerceAtMost(descending.size)
        var topKWeight = 0f
        for (i in 0 until k) topKWeight += descending[i]
        if (topKWeight <= 0f) return 0f
