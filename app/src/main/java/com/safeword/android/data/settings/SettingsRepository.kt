...
class SettingsRepository @Inject constructor(
    ...
    private object Keys {
        ...
        // Personalization
        val HOTWORD_BOOST_ENABLED = booleanPreferencesKey("hotword_boost_enabled")
        val AUTO_LEARN_DICTIONARY_ENABLED = booleanPreferencesKey("auto_learn_dictionary_enabled")
    }
    ...
    val settings: Flow<AppSettings> = context.dataStore.data.map { prefs ->
        ...
        AppSettings(
            ...
            hotwordBoostEnabled = prefs[Keys.HOTWORD_BOOST_ENABLED] ?: defaults.hotwordBoostEnabled,
            autoLearnDictionaryEnabled = prefs[Keys.AUTO_LEARN_DICTIONARY_ENABLED]
                ?: defaults.autoLearnDictionaryEnabled,
        )
    }
    ...
    suspend fun updateHotwordBoostEnabled(enabled: Boolean) {
        Timber.i("[SETTINGS] updateHotwordBoostEnabled | enabled=%b", enabled)
        context.dataStore.edit { it[Keys.HOTWORD_BOOST_ENABLED] = enabled }
    }

    suspend fun updateAutoLearnDictionaryEnabled(enabled: Boolean) {
        Timber.i("[SETTINGS] updateAutoLearnDictionaryEnabled | enabled=%b", enabled)
        context.dataStore.edit { it[Keys.AUTO_LEARN_DICTIONARY_ENABLED] = enabled }
    }
