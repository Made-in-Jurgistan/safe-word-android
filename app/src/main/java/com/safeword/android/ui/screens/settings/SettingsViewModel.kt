...
class SettingsViewModel @Inject constructor(
    ...
    fun updateHotwordBoostEnabled(enabled: Boolean) = viewModelScope.launch {
        Timber.d("[SETTINGS] SettingsViewModel.updateHotwordBoostEnabled | enabled=%b", enabled)
        settingsRepository.updateHotwordBoostEnabled(enabled)
    }

    fun updateAutoLearnDictionaryEnabled(enabled: Boolean) = viewModelScope.launch {
        Timber.d("[SETTINGS] SettingsViewModel.updateAutoLearnDictionaryEnabled | enabled=%b", enabled)
        settingsRepository.updateAutoLearnDictionaryEnabled(enabled)
    }
}
