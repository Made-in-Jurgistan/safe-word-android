...
@Composable
internal fun CompletePage(onComplete: () -> Unit) {
    Column(
        modifier = Modifier
            .fillMaxSize()
        ...
        Text(
            stringResource(R.string.onboarding_complete_headline),
        ...
        GlassCard(modifier = Modifier.fillMaxWidth()) {
            Text(
                stringResource(R.string.onboarding_complete_whats_next_title),
            ...
            Text(
                stringResource(R.string.onboarding_complete_whats_next_body),
        ...
        Button(
            ...
            Text(
                stringResource(R.string.onboarding_complete_action),
