            ...
            Column(
                ...
                SettingsCard {
                    GlassListItem(
                        headlineContent = {
                            Text(
                                stringResource(R.string.settings_personal_dictionary),
                                style = MaterialTheme.typography.bodyLarge,
                            )
                        },
                        supportingContent = {
                            Text(
                                stringResource(R.string.settings_personal_dictionary_desc),
                                style = MaterialTheme.typography.bodySmall,
                            )
                        },
                        trailingContent = {
                    ...
                    GlassListItem(
                        headlineContent = {
                            Text(
                                stringResource(R.string.settings_custom_commands),
                                style = MaterialTheme.typography.bodyLarge,
                            )
                        },
                        supportingContent = {
                            Text(
                                stringResource(R.string.settings_custom_commands_desc),
                                style = MaterialTheme.typography.bodySmall,
                            )
                        },
                        trailingContent = {
