    ...
    GlassCard(
        ...
        Column(modifier = Modifier.padding(horizontal = 16.dp, vertical = 12.dp)) {
            Row(
                ...
                Column {
                    Text(
                        stringResource(R.string.onboarding_step_title, stepNumber, stringResource(R.string.onboarding_step_a11y_title)),
                        style = MaterialTheme.typography.titleSmall,
                        fontWeight = FontWeight.SemiBold,
                    )
                    Text(
                        if (isDone) stringResource(R.string.onboarding_step_complete) else stringResource(R.string.onboarding_step_a11y_subtitle),
                        style = MaterialTheme.typography.bodySmall,
                        color = if (isDone) DoneGreen else GlassDimText,
                    )
                }
            ...
            if (!isDone) {
                ...
                Text(
                    text = "• ${stringResource(R.string.onboarding_step_a11y_disclosure_1)}",
                    style = MaterialTheme.typography.bodySmall,
                    color = GlassDimText,
                )
                Text(
                    text = "• ${stringResource(R.string.onboarding_step_a11y_disclosure_2)}",
                    style = MaterialTheme.typography.bodySmall,
                    color = GlassDimText,
                )
                Text(
                    text = "• ${stringResource(R.string.onboarding_step_a11y_disclosure_3)}",
                    style = MaterialTheme.typography.bodySmall,
                    color = GlassDimText,
                )
                ...
                Button(
                    ...
                    Text(stringResource(R.string.onboarding_step_a11y_check_status))
                }
            }
        }
    }
